...
# Is there a difference between the two, other than what operator she chose to use to concatenate
# an element to the buffer?

# Answer: Yes! The second method would be better, because the first one has a side effect and a meaningful return.
# The << mutates the buffer.
